...
## Project Structure
    ...
    ├── regressiontest_dev_24336  # Django project configurations
...
1. Clone this repo and `cd regressiontest_dev_24336`
...
2. Clone this repo and `cd regressiontest_dev_24336`
